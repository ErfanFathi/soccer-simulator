...
public:    
    ...
    Robot( PWorld* world, PBall* ball, dReal x, dReal y, dReal z, int rob_id, int wheeltexid, int dir );
    ~Robot();
    void step();
...
#define ROBOT_START_Z()  ( robotSetting_RobotHeight * 0.5 + robotSetting_WheelRadius * 1.1 + robotSetting_BottomHeight )
